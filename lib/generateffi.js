...
exports.generate = function (opts) {
  ...
  var defineType = function (type, unionName) {
    ...
    type.visitChildren(function(parent) {
        ...
        if (this.kind == Cursor.CXXAccessSpecifier)
        {
          return Cursor.Continue;
        }
        ...
        if (this.spelling) {
          ...
          if (this.kind == Cursor.TypeRef) {
            ...
            var result = defineFunction(this.mangling, this.type);
            if (result.abort) {
    ...
    if (type.kind === Type.Pointer && type.pointeeType.kind === Type.Char_S) {
      ...
      switch (type.kind)
      {
        ...
        case Type.Enum:
          ...
          break;
        case Type.Pointer:
          switch (type.pointeeType.declaration.kind)
          {
      ...
      switch (this.kind)
      {
        case Cursor.FunctionDecl:
          if (matchPrefix(this.spelling)) {
            ...
            //var fullName = currentNamespace.concat(this.spelling).join('::');
            var result = defineFunction(this.mangling, this.type);
            if (result.abort) {
              unmapped.push(result.abort);
              return Cursor.Continue;
        ...
        case Cursor.Namespace:
          currentNamespace.push(this.spelling);
          this.visitChildren(tuVisitor);
